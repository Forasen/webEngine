...
class MyWebSort
{
    public:
        ...
        void handleSearch(std::string task_str)
        {
            ...
            std::stringstream ss_result(task_str);
            std::string res_word;
            ...
            //std::stringstream ss_task(task_res);
            ...
            /*不断循环求交集，直到所有的对比完为止，剩下最小的交集才是最后的结果*/
